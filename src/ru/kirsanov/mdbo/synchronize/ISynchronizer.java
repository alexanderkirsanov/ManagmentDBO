...
public interface ISynchronizer {
    Model synchronize(Model model) throws SQLException, ColumnAlreadyExistsException, ColumnNotFoundException, ModelSynchronizerNotFound, TableNotFound, ViewNotFoundException;
}
